  ...
  workflows: [
    {
      ...
      options: {
        autoLogin: { default: false, description: 'Automatically login if not authenticated' },
        showDetails: { default: true, description: 'Show detailed user information' }
      },
      steps: [
        {
          name: 'load-session',
    ...
    },
    {
      ...
      options: {
        ...
        validateAfterLogin: { default: true, description: 'Validate session after login' }
      },
      steps: [
        {
